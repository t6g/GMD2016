...
systems arising during the Newton-Raphson solve, but, as the problems are 
...
% rmills: I moved the sentence about the OIC to here, where I think it fits 
% better with the flow the of the paper.  I would like to say something about 
% what the OIC Phase 5 *is* (e.g., "a cluster of Intel Xeon (whatever the SKU 
% is for the processors") and what compiler and choice of optimization flags 
% was used (since the choices made by the compiler's optimizer can affect 
% numerical results)
