...
detection limits are often above 10$^{-9}$ \chem{M}, these methods are expected to provide an accurate, efficient, and robust solution
...
\caption{Decreasing STOL can decrease and eliminate the numerical inhibition in the case of $10^{-10}$  \unit{mol\,m^{-3}}  in Fig. (\ref{fig:cax1yn2o}). \chem{N_2O-N} concentration in taxis in (b) is the minimum of the 10 soil layers.}
