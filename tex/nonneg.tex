...
\title{Coupling a Reactive
Transport Code with a Global Land Surface Model for Mechanistic Biogeochemistry
Representation: 1. Addressing the Challenge of Nonnegativity}
...
address the nonnegativity challenge to obtain accurate, efficient, and
...
the confirmation that the increase of \chem{CO_2}, \chem{CH_4}, and \chem{N_2O}
...
nitrogen cycles \citep{Oleson2013}. In addition to the over 250 soil biogeochemical
models developed in the past 80 years \citep{Manzoni2009}, increasingly
mechanistic models continued to be developed to increase the fidelity of
process representation with the hope for improved climate prediction
...
process understanding. To mitigate this issue, \citet{Fang2013} demonstrated
...
added a reaction solver developed from the reactive transport (geochemical)
...
TOUGH-REACT, was used to develop multi-phase (gas, aqueous, solid) mechanistic
...
transport code \citep[e.g.,][]{Steefel2014} with CLM will facilitate testing
...
%prediction. 
The nonnegative challenge arises in the coupling of a reactive transport code
with CLM as an essential aspect of these surface land models is the ability to simulate
...
simulation duration. With numerical error, the mass balance may be violated.
Avoiding numerical instability and error may result in extreme small time step
sizes or high computational cost. Therefore, it is necessary to address the
nonnegative challenge for accurate, robust, and efficient numerical simulation.  
...
uptake reactions (Fig. \ref{fig:conceptualmodel}) as an example. The reactions and rate formulae are detailed in Appendix .
