...
systems if the problem is large.
...
method involves solving a Jacobian system for each Newton-Raphson step (Eq. \ref{eq:axb}, which in practice is
usually done using Krylov subspace methods, and log transformation converts
the linear
