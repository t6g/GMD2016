...
data1 = openncyear('../run0/US-Brw_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
...
lgd = plt.legend(('CLM4.5', 'CLM-PF ($k_m = 10^{-3}$)', 'CLM-PF ($k_m = 10^{-6}$)', 'CLM-PF ($k_m = 10^{-9}$)'),loc=6)
...
ax2b = plt.axes([0.68, 0.64, 0.20, 0.09]) 
plt.plot(t, data1['vegc'], 'b-', t, data2['vegc'], 'r-', t, data3['vegc'], 'g-', t, data4['vegc'], 'm-')
plt.xlim([xminb, xmaxb])
plt.yticks([0, 5, 10, 15])
