...
data3 = openncyear('../run6_1yj/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
data4 = openncyear('../run6_1yl/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
...
plt.semilogy(t[::48], data1['nh4a'][::48], 'ro:', t[::48], data2['nh4a'][::48], 'g+:', t[::48], data3['nh4a'][::48], 'mx:', t[::48], data4['nh4a'][::48], 'b-', markersize=3)
plt.xlim([0, ny1])
plt.ylim([1e-7, 1e-0])
...
plt.semilogy(t[::48], data1['no3a'][::48], 'ro:', t[::48], data2['no3a'][::48], 'g+:',  t[::48], data3['no3a'][::48], 'mx:', t[::48], data4['no3a'][::48], 'b-', markersize=3)
plt.ylim([1e-7, 1e-1])
...
plt.semilogy(t, data1['nh4a'], 'r-', t, data2['nh4a'], 'g-', t, data3['nh4a'], 'm-', t, data4['nh4a'], 'b-')
plt.semilogy(t[::48], data1['nh4a'][::48], 'rx', t[::48], data2['nh4a'][::48], 'b+')
...
plt.semilogy(t, data1['no3a'], 'r-', t, data2['no3a'], 'g-', t, data3['no3a'], 'm-', t, data3['no3a'], 'b-')
plt.semilogy(t[::48], data1['no3a'][::48], 'rx', t[::48], data2['no3a'][::48], 'b+')
plt.xlim([xmina, xmaxa])
plt.xticks([226, 228, 230])
plt.ylim([1e-7, 1e-2])
plt.yticks([1e-7, 1e-5, 1e-3])
...
plt.semilogy(t, data1['no3a'], 'r-', t, data2['no3a'], 'g-', t, data3['no3a'], 'm-', t, data4['no3a'], 'b-')
plt.semilogy(t[::48], data1['no3a'][::48], 'rx', t[::48], data2['no3a'][::48], 'b+')
plt.xlim([xminb, xmaxb])
plt.xticks([250, 252, 254])
plt.ylim([1e-7, 1e-2])
...
plt.semilogy(t, data1['no3a'], 'r-', t, data2['no3a'], 'g-', t, data3['no3a'], 'm-', t, data4['nh4a'], 'b-')
plt.semilogy(t[::48], data1['no3a'][::48], 'rx', t[::48], data2['no3a'][::48], 'b+')
plt.xlim([xminc, xmaxc])
plt.xticks([295, 298, 300])
plt.ylim([1e-7, 1e-2])
