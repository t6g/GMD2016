...
data2 = openncyear('../run3cl/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
data3 = openncyear('../run4cl/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
data4 = openncyear('../run5cl/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
data5 = openncyear('../run6cl/BR-Cax_I1850CLM45CN_ad_spinup.clm2.h0.', ny0, ny1)
...
lgd = plt.legend(('CLM4.5', 'CLM-PF ($k_m = 10^{-3}$)', 'CLM-PF ($k_m = 10^{-4}$)', 'CLM-PF ($k_m = 10^{-5}$)', 'CLM-PF ($k_m = 10^{-6}$)'),loc=2)
